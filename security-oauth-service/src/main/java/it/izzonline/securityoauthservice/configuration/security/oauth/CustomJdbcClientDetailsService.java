package it.izzonline.securityoauthservice.configuration.security.oauth;
...
import it.izzonline.securityoauthservice.configuration.Constants;
import it.izzonline.securityoauthservice.service.cache.ClientDetailsCacheService;

/**
 * Manages the Oauth client information, including how to insert, update, etc
 * new ones.
 */
public class CustomJdbcClientDetailsService extends JdbcClientDetailsService {
	...
	public ClientDetails loadClientByClientId(String clientId) throws InvalidClientException {
		return clientDetailsCacheService.get(clientId).orElseGet(() -> {
