...
public class ClientDetailsCacheServiceTest {
	...
	static Stream<Arguments> containsTestCases() {
		...
		return Stream.of(
				...
				Arguments.of(null, false, false), Arguments.of(clientId, false, false),
				Arguments.of(clientId, true, true)); // @formatter:on
	}
	...
	static Stream<Arguments> getTestCases() {
		...
		return Stream.of(
				// @formatter:off
				// clientId, cacheServiceResult, expectedResult
				Arguments.of(null, empty(), empty()), Arguments.of(clientId, empty(), empty()),
				Arguments.of(clientId, cacheServiceResult, cacheServiceResult)); // @formatter:on
	}

	@ParameterizedTest
	@MethodSource("getTestCases")
	@DisplayName("get: test cases")
	public void get_testCases(String clientId, Optional<ClientDetails> cacheServiceResult,
			Optional<ClientDetails> expectedResult) {
		// When
	...
	static Stream<Arguments> putTestCases() {
		...
		return Stream.of(
				...
				Arguments.of(null, null, false, false), Arguments.of(clientId, null, false, false),
				Arguments.of(clientId, null, true, true), Arguments.of(clientId, clientDetails, true, true)); // @formatter:on
	}

	@ParameterizedTest
	@MethodSource("putTestCases")
	@DisplayName("put: test cases")
	public void put_testCases(String clientId, ClientDetails clientDetails, boolean cacheServiceResult,
